...
class Transcript extends React.Component {
    constructor(props) {
        ...
        this.default_language = 'korean';
        console.log("wtf",this.props.language)
        if (this.props.language) {
            this.default_language = this.props.language;
        } else {
            this.default_language = 'korean'
        }
        this.defaultTranslate = this.languageOptions[this.default_language];
        console.log("this is defalt lang no", this.defaultTranslate)
    ...
    refreshLang = lang => this.setState({backgroundlang: lang});

    componentWillReceiveProps(props) {
        const { language } = props;
        if (language !== this.default_language) {
            this.refreshLang(language);
        }
    }

    render() {
        const default_language = this.props.lang;
